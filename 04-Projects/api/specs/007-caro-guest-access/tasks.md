...
- [ ] T007 [US2] Validate [quickstart.md](quickstart.md) step 1 (guest viewing a public match/moves → `200`) and step 2 (guest viewing a private match → `404`, not `403`).
